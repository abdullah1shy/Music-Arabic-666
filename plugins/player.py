...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text((190, 550), f"تاريخ النشر 🧭: {title[:50]} ...", (255, 255, 255), font=font)
    draw.text((190, 590), f"المدة ⌛: {duration}", (255, 255, 255), font=font)
    draw.text((190, 630), f"المشاهدات 👁️: {views}", (255, 255, 255), font=font)
    draw.text(
        (190, 670),
        f"Powered By: ZEUS",
        (255, 255, 255),
